...
"[project]/app/api/ownercover/handleInbound/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function decideAction(settings, text) {
    ...
    const action = settings.mode === "off" ? "monitor" : settings.mode === "monitor" ? "await-approval" : confidence >= settings.confidenceThreshold && !restricted && !quiet ? "auto-send" : "await-approval";
    return {
        action,
        confidence,
        restricted: restricted || quiet,
        quietHours: quiet
    };
}
async function POST(request) {
    ...
    const settings = uid === "dev" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$devStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOwnerCoverSettings"])() : await (async ()=>{
        const settingsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"], "ownerCoverSettings", uid);
        const settingsSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDoc"])(settingsRef);
        return settingsSnap.exists() ? {
            ...DEFAULT_SETTINGS,
            ...settingsSnap.data()
        } : DEFAULT_SETTINGS;
    })();
    const decision = decideAction(settings, text);
    if (uid === "dev") {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$devStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addAction"])({
            action: decision.action,
            confidence: decision.confidence,
            restricted: decision.restricted,
            response: "Draft response created by Owner Cover.",
            reason: decision.restricted ? "Restricted topic or quiet hours require approval." : decision.confidence < settings.confidenceThreshold ? "Confidence below threshold." : "Within guardrails.",
            message: text,
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"], "actionQueue"), {
            uid,
            status: decision.action === "auto-send" ? "sent" : "queued",
            action: decision.action,
            confidence: decision.confidence,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fbfb8f95._.js.map