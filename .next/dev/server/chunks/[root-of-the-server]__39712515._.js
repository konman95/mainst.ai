...
function decideAction(settings, text) {
    ...
    const action = settings.mode === "off" ? "monitor" : settings.mode === "monitor" ? "await-approval" : confidence >= settings.confidenceThreshold && !restricted ? "auto-send" : "await-approval";
    return {
        action,
        confidence,
        restricted
...
//# sourceMappingURL=%5Broot-of-the-server%5D__39712515._.js.map