...
;
const BASE = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE_URL || (("TURBOPACK compile-time truthy", 1) ? "/api" : "TURBOPACK unreachable");
...
function OwnerCover() {
        ...
        "OwnerCover.useEffect": ()=>{
            ...
            async function load() {
                ...
                try {
                    ...
                    if (active) setActions(actionData || []);
                } catch (e) {
    ...
    async function saveSettings() {
        ...
        setError(null);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].ownerSet(settings);
            setSettings(data);
        } catch (e) {
...
_s(OwnerCover, "NK6Xy0Yw/2OnNldQtEA7DZ0cZME=");
_c = OwnerCover;
var _c;
...
//# sourceMappingURL=_80b45a4d._.js.map